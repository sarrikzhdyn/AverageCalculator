...
namespace ShapeWPF
{
    public class ElectronicsProduct : IProduct
    {
        ...
        public ElectronicsProduct(string name, double pricePerUnit, int stockQuantity, double warrantyMonths)
        {
            ...
            if (warrantyMonths < 0) throw new ArgumentException("Гарантия не может быть отрицательной!");
